	...
	<body>
		...
		<div id="show-director" class="content scaffold-show" role="main">
			...
			<ol class="property-list director">
				...
				<g:if test="${directorInstance?.lastName}">
				<li class="fieldcontain">
					<span id="lastName-label" class="property-label"><g:message code="director.lastName.label" default="Last Name" /></span>
					
						<span class="property-value" aria-labelledby="lastName-label"><g:fieldValue bean="${directorInstance}" field="lastName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${directorInstance?.movies}">
				<li class="fieldcontain">
					<span id="movies-label" class="property-label"><g:message code="director.movies.label" default="Movies" /></span>
